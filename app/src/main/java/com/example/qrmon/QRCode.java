...
public class QRCode {
    ...
    QRCode(String name, ImageView visual, ImageView picture, String comment, String geolocation, String hash, String url, Integer score) {
        this.name = name;
        //this.visual = visual;
    ...
    public void setVisual(ImageView newVisual) {this.visual = newVisual;}
